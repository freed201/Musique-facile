...
export default defineConfig({
  ...
  output: 'hybrid',
  // Forme canonique des URLs : AVEC slash final (aligné sur vercel.json >
  // trailingSlash: true, qui redirige déjà /page → /page/ en prod). Fait
  // échouer en dev les liens internes sans slash → régressions visibles tôt.
  // Au build, l'adapter Vercel repasse en « ignore » (WARN attendu, sans
  // conséquence) : en prod c'est vercel.json qui applique la redirection.
