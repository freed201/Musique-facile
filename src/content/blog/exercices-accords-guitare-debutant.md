...
**🎯 Étapes :**  
1️⃣ Jouez un accord lentement.  
2️⃣ **Vérifiez que toutes les cordes sonnent bien** en les jouant une par une.  
3️⃣ Ajustez la position de vos doigts si certaines cordes grésillent.  
4️⃣ Passez au suivant et répétez l’exercice pour chaque accord appris.  
...
**🎯 Étapes :**  
1️⃣ **Choisissez 2 accords faciles**, par ex. **C → G** ou **Em → Am**.  
2️⃣ Mettez un chronomètre sur **1 minute**.  
3️⃣ Alternez entre ces accords **le plus de fois possible** sans vous arrêter.  
4️⃣ Notez votre score et essayez de **l’améliorer chaque jour**.  
...
🔹 **Progression 1 (Pop/Rock)** :  
**C → G → Am → F**  

🔹 **Progression 2 (Folk)** :  
**G → D → Em → C**  

🔹 **Progression 3 (Blues simplifié)** :  
**E → A → B7**  

🔹 **Progression 4 (Mélancolique)** :  
**Am → F → C → G**  

**🎯 Étapes :**  
1️⃣ Jouez chaque accord pendant **4 temps** avant de passer au suivant.  
2️⃣ Commencez **lentement** (50 BPM) et accélérez progressivement.  
...
**🎯 Étapes :**  
1️⃣ Réglez un métronome sur **60 BPM**.  
...
| 🎵 Chanson | 🎸 Accords utilisés |
|-----------|----------------|
| Knockin’ on Heaven’s Door - Bob Dylan | G - D - Am |
| Imagine - John Lennon | C - F - G |
| Perfect - Ed Sheeran | G - Em - C - D |

**🎯 Étapes :**  
1️⃣ **Jouez lentement** en suivant la grille d’accords.  
